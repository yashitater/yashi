...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Yashi\\Desktop\\Lab in Psychology\\motor sequence learning task_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='sequential', 
    ...
    trialList=data.importConditions('C:/Users/Yashi/Desktop/Lab in Psychology/sequence_con.csv'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if probe.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > probe.tStartRefresh + 1.0-frameTolerance:
                # keep track of stop time/frame for later
